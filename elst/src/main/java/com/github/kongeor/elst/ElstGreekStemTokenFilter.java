...
/**
 * A {@link TokenFilter} that applies {@link ElstGreekStemmer} to stem Greek
 * words.
 * <p>
 ...
 * Greek stemmer.
 */
public class ElstGreekStemTokenFilter extends TokenFilter {
    private final ElstGreekStemmer stemmer = new ElstGreekStemmer();
    private final CharTermAttribute termAtt = addAttribute(CharTermAttribute.class);
    private final KeywordAttribute keywordAttr = addAttribute(KeywordAttribute.class);

    public ElstGreekStemTokenFilter(TokenStream input) {
        super(input);
    }
